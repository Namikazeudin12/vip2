...
![Screenshot 2024-06-05 082544](https://github.com/Namikazeudin12/vip2/assets/158546743/ee0b4e39-3384-4cb9-bf74-ba72b89a2a43)

### INSTALL SCRIPT 
```
apt install -y && apt update -y && apt upgrade -y && wget -q https://raw.githubusercontent.com/Namikazeudin12/vip2/main/premi.sh && chmod +x premi.sh && ./premi.sh
```

## UPDATE SCRIPT
```
wget -q https://raw.githubusercontent.com/Namikazeudin12/vip2/main/update.sh && chmod +x update.sh && ./update.sh
```
...
Membuat Bot Baru:
![Screenshot 2024-06-04 115130](https://github.com/Namikazeudin12/vip2/assets/158546743/1ef8e3f2-945a-4590-a85e-f14f1b78d7e7)
...
- 
  ![Screenshot 2024-06-05 082241](https://github.com/Namikazeudin12/vip2/assets/158546743/e97b1869-a38a-4899-a5fb-3a6b331b3558)
