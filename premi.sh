...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO SCRIPT AUTO VPN SELVNVMASA ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}SELVNVMASA® ${NC}${YELLOW}(${NC}${green}V 3.2${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅝: KONOHA PRIDE ${YELLOW}(${NC} 2025 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Namikzeudin12/vip2/main/"
...
clear
izinsc="https://raw.githubusercontent.com/Namikazeudin12/vip2/main/izin"
# USERNAME
rm -f /usr/bin/user
...
<code>─────────────────────────────</code>
<b> SELVNVMASA VPN STORE SCRIPT  </b>
<code>─────────────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/S3LVNVMMASA"}]]}' 
...
wget -q https://raw.githubusercontent.com/Namikzeudin12/vip2/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
wget -q -O /etc/default/dropbear https://raw.githubusercontent.com/Namikazeudin12/vip2/main/config/dropbear.conf
...
wget -q https://raw.githubusercontent.com/Namikzeudin12/vip2/main/udp-custom/udp-custom.sh
...
# Ganti Banner
wget -O /etc/hokage.txt https://raw.githubusercontent.com/Namikazeudin12/vip2/main/files/issue.net
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY SELVNVMASA GANTENK ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
